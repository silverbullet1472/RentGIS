...
UA_list = [
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; .NET4.0E; 360SE)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; {D9D54F49-E51C-445e-92F2-1EE3C2313240}; .NET CLR 2.0.50727; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729)",
    ...
    "Mozilla/5.0 (Windows U Windows NT 5.1 ru rv:1.9.2.16) Gecko/20110319 MRA 5.7 (build 03797) Firefox/3.6.16 ( .NET CLR 3.5.30729) sputnik 2.1.0.18",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; .NET CLR 1.1.4322; .NET CLR 2.0.50727; .NET CLR 3.0.04506.30; .NET CLR 3.0.04506.648; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; .NET4.0C; .NET4.0E; 360SE 3.0)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; iCafeMedia; icafe8; Sicent; WoShiHoney.B; Media Center PC 6.0; Microsoft Windows Media Center PC 6.0)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; QQDownload 718; Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1) ; .NET CLR 2.0.50727; .NET CLR 3.0.04506.30)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727)",
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET4.0C; .NET4.0E; .NET CLR 3.5.30729; .NET CLR 3.0.30729)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; BTRS125127; .NET CLR 2.0.50727; .NET CLR 1.1.4322; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; BTRS100200; .NET CLR 2.0.50727; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; .NET4.0C; 360SE)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; qdesk 2.3.1186.202; 360SE)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; .NET CLR 2.0.50727; .NET CLR 3.0.04506.30; 360SE)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; GTB7.5; doyo 2.1.4)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; QQDownload 718; qdesk 2.4.1265.203)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.1.4322; .NET CLR 2.0.50727; .NET4.0C; .NET4.0E; 360SE)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; Media Center PC 6.0; SE 2.X MetaSr 1.0)",
    ...
    "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/4.0; GTB7.2; qdesk 2.3.1186.202; QQDownload 715; Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1) ; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; Tablet PC 2.0) QQBrowser/6.14.14517.201",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; BTRS129736; .NET CLR 2.0.50727; SE 2.X MetaSr 1.0)",
    "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; Trident/4.0; .NET CLR 2.0.50727; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729)",
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 2.0.50727; .NET4.0C; .NET4.0E; InfoPath.2)",
    ...
    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Trident/4.0; zh-cn; .NET CLR 3.0.30618; .NET CLR 3.0.30729; .NET CLR 1.1.4322; Media Center PC 3.1; SV1; .NET4.0C; YPC 3.2.0; 360SE)",
...
def ultimate_request(url, allow_exception=False, referer=None):
    if allow_exception:
        timeout = 10
    else:
        timeout = 20
    ...
    while True:
        ...
        try:
            ...
            # elif 4 <= func <= 9:
            #     r = qingting_request(url, timeout)
            # elif 10 <= func <= 10:
            ...
            if r.status_code != 200:
                ...
                print("status_code不为200:" + str(r.status_code))
            elif r.text.strip() == '':
                extract_num = extract_num + 1
                print("返回为空")
            elif '过于频繁' in r.text:
                ...
                extract_num = extract_num + 1
                print("速度太快")
            elif "<title>Error</title>" in r.text:
                extract_num = extract_num + 1
                print("Error")
            elif "拒绝访问" in r.text:
                extract_num = extract_num + 1
                ...
                extract_num = extract_num + 1
                print("出错了")
            elif "http://tieba.baidu.com/" in r.text:
                extract_num = extract_num + 1
                print("我透 怎么跑出百度链接")
            elif "在线客服" in r.text:
                print("我透 怎么跑出58客服")
                ...
                print("reqeust次数:" + str(request_num) + " extract次数:" + str(extract_num))
                return r
            # 每次出错都进行如下处理
            # print("这个链接出错了:代理编号:" + str(int((func-45) > 0)))
            if frequent_num > 0:
...
def xici_request(url, timeout):
    ...
    proxy = {rand_proxy[2]: rand_proxy[2] + '://' + rand_proxy[0] + ':' + rand_proxy[1]}
    # 提交事务，关闭数据库连接
    conn.commit()
    conn.close()
...
def original_request(url, timeout, referer=None):
    ua = random.choice(UA_list)
    if referer:
        headers = {
...
def kuai_request(url, timeout, referer=None):
    ua = random.choice(UA_list)
    # 隧道服务器
...
def yiniu_request(url, timeout, referer=None):
    ua = random.choice(UA_list)
...
def qingting_request(url, timeout):
    ua = random.choice(UA_list)
...
if __name__ == "__main__":
    # xun 40 5 /1 qinting 0 0 5 5 /6 yiniu 5 0 /12 xici 0 0 0 0 5 0 /3
    # /beitaipingzhuang/zufang/pn4/
    # exception_num = 0
    # wrong_status_num = 0
    # for i in range(0, 20):
    #     print("try:"+str(i))
    #     try:
    #         r = ultimate_request("http://bj.ganji.com/zufang/")
    #     except Exception as e:
    #         exception_num = exception_num + 1
    #     else:
    #         if r.status_code != 200:
    #             wrong_status_num = wrong_status_num + 1
    # print("exption time:" + str(exception_num))
    # print("exception rate:" + str(exception_num * 5))
    # print("wrong times:" + str(wrong_status_num))
    # print("wrong rate:" + str(wrong_status_num * 5))
    #
    # exception_num = 0
    # wrong_status_num = 0
    # for i in range(0, 20):
    #     print("try:"+str(i))
    #     try:
    #         r = ultimate_request("http://bj.ganji.com/ershoufang/")
    #     except Exception as e:
    #         exception_num = exception_num + 1
    #     else:
    #         if r.status_code != 200:
    ...
    # print("wrong times:" + str(wrong_status_num))
    # print("wrong rate:" + str(wrong_status_num * 5))
    #  r = ultimate_request1("http://bj.ganji.com//ershoufang/")
    #  print(r.text)
